                ...
                <div class="max-w-7xl mx-auto px-4 space-y-8 sm:px-6 lg:px-8">
                    ...
                    <div class="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-start">
                        <div class="relative z-10">
                            ...
                            <div
                                class="mt-10 flex text-base max-w-prose mx-auto lg:max-w-none"
                            >
                        ...
                        >
                            ...
                            >
                                <div
                                    class="rounded-t-lg px-6 py-8 sm:px-10 sm:pt-10 sm:pb-8"
                                >
                                    <img
                                    ...
                                    />
                                    <div
                                        class="relative text-lg text-gray-700 font-medium mt-8"
                                    >
                                        <svg
                                ...
                                >
                                    ...
                                    >
                                        <p
                                            class="text-white font-semibold sm:inline"
                                        >
                                            Judith Black
                                        </p>
                                        {{ " " }}
