...
return [
    ...
    'classes' => [
        ...
        'button' => 'inline-flex place-center px-4 py-3 h-10 border-0 bg-indigo-600 hover:bg-indigo-600 active:bg-indigo-600 overflow-hidden rounded-sm text-white leading-none no-underline',
    ],
